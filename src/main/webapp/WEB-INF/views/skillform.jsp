					...
					<div class="x_content">
						...
						<table class="table table-striped">
							...
							<tr>
									...
									<h2>Skill Form</h2>
								<spring:url value="/skill/save"
																	  var="saveURL" />
								<fieldset>
									<form:form modelAttribute="Skill" method="POST"
										...
										<div id="taskInfo">
													...
													<c:otherwise>
														<div class="col-md-8 inputGroupContainer">
															<div class="input-group">
																			<span class="input-group-addon"><i
																					class="glyphicon glyphicon-tags"></i></span>
																<form:input id="skillId" path="skillId"
											...
											<div class="form-group">
												<label class="control-label col-sm-2 requiredField">
													Skill Name <span class="asteriskField"> * </span>
												</label>
												<div class="col-md-8 inputGroupContainer">
													<div class="input-group">
																	<span class="input-group-addon"><i
														...
														<form:input path="skillName"
																	placeholder="skillName" cssClass="form-control"
																	required="required" />
													</div>
												</div>
											</div>
