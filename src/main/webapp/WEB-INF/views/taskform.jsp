                                                        ...
                                                        <div id="staffCombobox">
															...
															<span class="input-group-addon"><i
                                                                    class="glyphicon glyphicon-search"></i></span>
                                                                        <form:select path="previousTask"
                                                                                     class="form-control">
                                                                            <form:option value=""
                                                                                         label="--- Task cần làm trước ---"/>
                                                        ...
                                                        <div id="taskInfo">
															...
															* </span>
                                                            ...
                                                            <c:if test="${not empty task.taskId }">
																...
																<span class="input-group-addon"><i
                                                                        class="glyphicon glyphicon-th-list"></i></span>
                                                                            <form:select path="taskState"
                                                                                         class="form-control"
                                                                                         id="sel1" style="height:30px"
                                                                                         required="required">
                                                                                <form:option value="0"
                                                                                             label="--- Select ---"/>
                                                            ...
                                                            <c:if test="${empty task.taskId}">
                                                                <form:input type="hidden" path="taskState"
                                                                            value="0"></form:input>
                                                            </c:if>
